...
constants defined  in section \ref{sec:arithmos}.
...
number sets defined in this paper, the numerical constants,
operations, relations and special functions.

The \LaTeX{} commands listed here are defined in the style file
\verb|zarithm.sty|.

\subsection{\LaTeX{} Commands for Number Sets}
\label{sec:latex-commands-number-sets}
The commands for number sets is shown in table
\ref{tab:latex-number-sets}.

\begin{table}[htbp]
  \centering
  \begin{tabular}{ll}
    $\arithmos$    & \verb|\arithmos| \\
    $\arithmos_1$  & \verb|\arithmos_1| \\
    $\real$        & \verb|\real| \\
    $\realplus$    & \verb|\realplus| \\ 
    $\realminus$   & \verb|\realminus| \\
    $\rat$         & \verb|\rat| \\
    $\rat_1$         & \verb|\rat_1| \\
    $\ratplus$    & \verb|\ratplus| \\ 
    $\ratminus$   & \verb|\ratminus| \\
  \end{tabular}
...
%
\subsection{\LaTeX{} Commands for Numerical Constants}
\label{sec:latex-commands-numerical-constants}
The commands for constants is shown in table
\ref{tab:latex-constants}.
...
\end{table}
%
\subsection{\LaTeX{} Commands for unary Operators}
\label{sec:latex-commands-unary-operators}
Table \ref{tab:latex-unary-operators} shows commands to typeset
unary operators.
\begin{table}[htbp]
  \centering
  \begin{tabular}{ll}
...
\end{table}
%
\subsection{\LaTeX{} Commands for binary Operators}
\label{sec:latex-commands-binary-operators}
Table \ref{tab:latex-binary-operators} shows commands to typeset
binary operators.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llll}
    ...
    \hline \\
    $\aplus$ & $\arithmos, \real, \rat$ & $\arithmos, \real, \rat$ & \verb|\aplus| \\
    $\aplusz$ & $\num$ & $\arithmos, \real, \rat$ & \verb|\azplus| \\
    $\azplus$ & $\arithmos, \real, \rat$ & $\num$ & \verb|\aplusz| \\
    $\aminus$ & $\arithmos, \real, \rat$ & $\arithmos, \real, \rat$ & \verb|\aminus| \\
    $\aminusz$ & $\num$ & $\arithmos, \real, \rat$ & \verb|\azminus| \\
    $\azminus$ & $\arithmos, \real, \rat$ & $\num$ & \verb|\aminusz| \\
    $\amult$ & $\arithmos, \real, \rat$ & $\arithmos, \real, \rat$ & \verb|\amult| \\
    $\amultz$ & $\num$ & $\arithmos, \real, \rat$ & \verb|\azmult| \\
    $\azmult$ & $\arithmos, \real, \rat$ & $\num$ & \verb|\amultz| \\
    $\adiv$ & $\arithmos, \real, \rat$ & $\arithmos_1, \real_1, \rat_1$ & \verb|\adiv| \\
    $\adivz$ & $\num$ & $\arithmos_1, \real_1, \rat_1$ & \verb|\azdiv| \\
    $\azdiv$ & $\arithmos, \real, \rat$ & $\num \setminus \{0\}$ & \verb|\adivz| \\
    \hline
  \end{tabular}
...
\subsection{\LaTeX{} Commands for Relations}
\label{sec:latex-commands-relations}
Table \ref{tab:latex-relations} shows commands to typeset relations.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llll}
    ...
    \hline \\
    $=$ & $\arithmos, \real, \rat$ & $\arithmos, \real, \rat$ & \verb|=| \\
    $\aaeqz$ & $\arithmos, \real, \rat$ & $\num$ & \verb|\aaeqz| \\
    $\azeqa$ & $\num$ & $\arithmos, \real, \rat$ & \verb|\azeqa| \\
...
\end{table}
%
\subsection{\LaTeX{} Commands for special Functions}
\label{sec:latex-commands-special-functions}
Table \ref{tab:latex-special-functions} shows commands to typeset
special functions.
