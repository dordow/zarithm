...
There is a special complex constant $\ai$:
%
\begin{axdef}
  \ai : \complex
  \where
  \ai \amult \ai = \aneg \aone
\end{axdef}
...
\begin{zed}
  \forall z : \complex @ z = \Re(z) \aplus \ai \amult \Im(z)
\end{zed}
%
...
% \end{axdef}
\begin{zed}
  \aconj == (\lambda z: \complex @ \Re(z) \aminus \ai \amult \Im(z)) 
\end{zed}
%
...
\begin{table}[htbp]
  ...
  \begin{tabular}{llp{1cm}ll}
    $\arithmos$    & \verb|\arithmos| && $\rat$ & \verb|\rat| \\
    $\arithmos_1$  & \verb|\arithmos_1| && $\rat_1$ & \verb|\rat_1| \\
    $\real$        & \verb|\real| && $\ratplus$ & \verb|\ratplus| \\ 
    $\realplus$    & \verb|\realplus| && $\ratminus$ & \verb|\ratminus| \\
